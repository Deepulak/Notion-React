...
Notion is the connected workspace where better, faster work happens. Now with AI */}
    ...
    <div className='sm:ml-6 md:text-8xl md:pl-9 md: mt-1 text-black font-bold sm:text-7xl sm:mt-1'>
   ...
   <button className='sm:mb-1 sm:ml-32 flex flex-col md:left-96 items-center justify-center bg-black w-40 h-10 text-white rounded-full md:ml-96'>Get Notion free →</button>
